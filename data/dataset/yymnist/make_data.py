...
image_paths = [os.path.join(os.path.realpath("."), "./data/dataset/yymnist/mnist/train/" + image_name) for image_name in os.listdir("./data/dataset/yymnist/mnist/train")]
image_paths += [os.path.join(os.path.realpath("."), "./data/dataset/yymnist/mnist/test/"  + image_name) for image_name in os.listdir("./data/dataset/yymnist/mnist/test")]
